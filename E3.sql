...
Insert into EROSKETA (deskontua, erosketa_eguna, kantitatea, factura, NAN) values (1, '2023-02-09', 5, 5.5, '79963569P');
Insert into EROSKETA (deskontua, erosketa_eguna, kantitatea, factura, NAN) values (2, '2023-02-10', 2, 5.5, '79582125L');

Insert into SARRERA (id_erosketa, id_saioa) values (1, 1);
Insert into SARRERA (id_erosketa, id_saioa) values (2, 4);
Insert into SARRERA (id_erosketa, id_saioa) values (3, 3);


SELECT f.film_izena, SUM(e.factura) AS 'Diru Totala'
